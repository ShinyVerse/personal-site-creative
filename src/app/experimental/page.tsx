...
export const landingStyles = tv({
  slots: {
    ...
    ctaWrapper: "mt-auto mb-30 text-center",
    section: "flex flex-col items-center h-screen",
    textBlock: "text-lato text-white text-xl font-block font-medium",
    cta: "border-2 border-secondary font-bold text-white rounded-2xl flex flex-row justify-center items-center gap-2 mt-4 px-6 py-3 hover:text-secondary active:bg-primary active:border-primary active:text-black",
